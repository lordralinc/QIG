...
generator_1600_900 = QuoteGenerator(
    bi=(1600, 900),
    pipeline=[
        pipelines.GradientBackgroundPipeLine(),
        pipelines.GridResizePipeLine(),
...
output_1600_900 = generator_1600_900.generate_quote(
    box_keys=[
        "title_box",
        "quote_box",
        "author_name_box",
    ...
    author_image_vertical_align="top",
    author_image_horizontal_align="left",
)

generator_900_900 = QuoteGenerator(
    bi=(900, 900),
    pipeline=[
        pipelines.GradientBackgroundPipeLine(),
        pipelines.GridResizePipeLine(),
...
output_900_900 = generator_900_900.generate_quote(
    box_keys=[
        "title_box",
        "quote_box",
        "author_name_box",
...
Image.open(io.BytesIO(output_1600_900)).save("pics/resize_1600_900_quote.png")
Image.open(io.BytesIO(output_900_900)).save("pics/resize_900_900_quote.png")
